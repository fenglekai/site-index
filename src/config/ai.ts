...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      url: "https://poe.com/",
      introduction:
        "Poe可让您提问、获得即时回答、并与AI机器人互动对话。提供GPT-4、gpt-3.5-turbo、Anthropic Claude以及其他多种机器人的访问权限。",
    },
    {
      site: "秒画AI",
    ...
    },
    {
      ...
      introduction:
        "KLING AI，基于最先进的生成式 AI 方法，用于创建富有想象力的图像和视频的工具。",
    },
    {
      site: "稿定",
      url: "https://www.gaoding.com/",
      introduction:
        "稿定一站式在线设计工具平台，提供全面的图片处理、设计工具和创建设计功能。支持AI抠图、AI消除、图片变清晰等智能处理，涵盖创意画布、H5页面制作、视频剪辑等多种工具，助您快速创建专业设计作品。丰富模板资源，让设计更高效便捷。",
    },
    {
      site: "即梦AI",
